...
const SIGNAL_EVENT_SYSTEM_PROMPT = [
  ...
  "- When writing source_free_signal_insight, summarize chart/evidence insight rather than listing metrics: explain what the move appears to be doing, why it is internally coherent or weak, and what remains unconfirmed.",
