...
| ITEM-allowed-with-limits-a-worker-and-d1-setup-71e54a04 | allowed_with_limits | A. Worker and D1 setup | docs/scopian/sources/15_DEPLOYMENT_CHECKLIST.md#a-worker-and-d1-setup | none | not_checked_in_generated_view |
...
| ITEM-allowed-with-limits-b-external-market-ingestion-thro-4fa1441a | allowed_with_limits | B. External market ingestion through Cloudflare-controlled GitHub dispatch | docs/scopian/sources/15_DEPLOYMENT_CHECKLIST.md#b-external-market-ingestion-through-cloudflare-controlled-github-dispatch | none | not_checked_in_generated_view |
...
| ITEM-allowed-with-limits-c-pages-setup-f87cc435 | allowed_with_limits | C. Pages setup | docs/scopian/sources/15_DEPLOYMENT_CHECKLIST.md#c-pages-setup | none | not_checked_in_generated_view |
...
| ITEM-allowed-with-limits-d-cors-readiness-a3b64741 | allowed_with_limits | D. CORS readiness | docs/scopian/sources/15_DEPLOYMENT_CHECKLIST.md#d-cors-readiness | none | not_checked_in_generated_view |
...
| ITEM-allowed-with-limits-deterministic-daily-overview-gen-dc611609 | allowed_with_limits | Deterministic Daily Overview Generation: Generate rows for complete UTC days only by default.; `day_start` is `YYYY-MM-DDT00:00:00.000Z`.; `day_end` is `YYY ... | docs/scopian/sources/16_V02_PRODUCTION_INTEGRATION_SPEC.md#deterministic-daily-overview-generation | none | not_checked_in_generated_view |
| ITEM-allowed-with-limits-e-security-checks-a7949e86 | allowed_with_limits | E. Security checks | docs/scopian/sources/15_DEPLOYMENT_CHECKLIST.md#e-security-checks | none | not_checked_in_generated_view |
...
| ITEM-allowed-with-limits-g-post-deploy-monitoring-e698c330 | allowed_with_limits | G. Post-deploy monitoring | docs/scopian/sources/15_DEPLOYMENT_CHECKLIST.md#g-post-deploy-monitoring | none | not_checked_in_generated_view |
...
| ITEM-allowed-with-limits-source-reference-versioning-sign-8d6c0e79 | allowed_with_limits | Source Reference Versioning: `signal_event_v02`; `daily_overview_v02`; `market_story_v02` | docs/scopian/sources/16_V02_PRODUCTION_INTEGRATION_SPEC.md#source-reference-versioning | none | not_checked_in_generated_view |
...
| ITEM-likely-out-of-scope-approved-v0-2-model-daily-overvi-17c3d84b | likely_out_of_scope | Approved v0.2 Model: `daily_overview`: Claude-backed full UTC-day context. One Daily Overview exists for every UTC day in the visible feed range.; `market_s ... | docs/scopian/sources/16_V02_PRODUCTION_INTEGRATION_SPEC.md#approved-v0-2-model | read-only | not_checked_in_generated_view |
...
| ITEM-likely-out-of-scope-claude-responsibility-boundary-s-c28c8954 | likely_out_of_scope | Claude Responsibility Boundary: `signal_event_v02`; `daily_overview_v02`; `market_story_v02`; `audit_event_v02` | docs/scopian/sources/16_V02_PRODUCTION_INTEGRATION_SPEC.md#claude-responsibility-boundary | none | not_checked_in_generated_view |
